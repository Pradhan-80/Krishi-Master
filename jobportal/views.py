...
def job_list_View(request):
    ...
    return render(request, 'main/job-list.html', context)
...
def create_job_View(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect(reverse("jobportal:single-job", kwargs={
                                    'id': instance.id
                                    }))
    ...
    return render(request, 'main/post-job.html', context)
...
def single_job_view(request, id):
    ...
    return render(request, 'main/job-single.html', context)
...
def all_applicants_view(request, id):
    ...
    return render(request, 'main/all-applicants.html', context)
...
def applicant_details_view(request, id):
    ...
    return render(request, 'main/applicant-details.html', context)
...
def job_edit_view(request, id=id):
    ...
    return render(request, 'jobportal/job-edit.html', context)
